...
public class Model {
     ...
     * @return The Model
     */
    public static Model fromString(final String string) {
     ...
     * @return The Model
     */
    public static Model fromString(final String model, final boolean ignoreErrors) {
