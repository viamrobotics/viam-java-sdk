...
public class Subtype {
    ...
    public static Subtype fromResourceName(final Common.ResourceName resourceName) {
        return new Subtype(resourceName.getNamespace(), resourceName.getType(), resourceName.getSubtype());
    }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(namespace, subtype.namespace) && Objects.equals(resourceType, subtype.resourceType) && Objects.equals(resourceSubtype, subtype.resourceSubtype);
    }
     ...
     * @return A new Subtype
     */
    public static Subtype fromString(final String string) {
        ...
        final String resourceSubtype = matcher.group(3);
