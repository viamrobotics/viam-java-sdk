...
public interface EvalStateOrBuilder extends
   ...
   * <code>repeated .google.api.expr.v1alpha1.ExprValue values = 1 [json_name = "values"];</code>
   */
  java.util.List<? extends com.google.api.expr.v1alpha1.ExprValueOrBuilder> 
   ...
   * <code>repeated .google.api.expr.v1alpha1.ExprValue values = 1 [json_name = "values"];</code>
   */
  com.google.api.expr.v1alpha1.ExprValueOrBuilder getValuesOrBuilder(
      int index);
   ...
   * <code>repeated .google.api.expr.v1alpha1.EvalState.Result results = 3 [json_name = "results"];</code>
   */
  java.util.List<? extends com.google.api.expr.v1alpha1.EvalState.ResultOrBuilder> 
   ...
   * <code>repeated .google.api.expr.v1alpha1.EvalState.Result results = 3 [json_name = "results"];</code>
   */
  com.google.api.expr.v1alpha1.EvalState.ResultOrBuilder getResultsOrBuilder(
      int index);
}
