...
public final class ServiceControllerGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.api.servicecontrol.v2.CheckRequest,
      com.google.api.servicecontrol.v2.CheckResponse> getCheckMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.api.servicecontrol.v2.CheckRequest,
      com.google.api.servicecontrol.v2.CheckResponse> getCheckMethod() {
    io.grpc.MethodDescriptor<com.google.api.servicecontrol.v2.CheckRequest, com.google.api.servicecontrol.v2.CheckResponse> getCheckMethod;
      ...
      synchronized (ServiceControllerGrpc.class) {
        if ((getCheckMethod = ServiceControllerGrpc.getCheckMethod) == null) {
          ServiceControllerGrpc.getCheckMethod = getCheckMethod =
              io.grpc.MethodDescriptor.<com.google.api.servicecontrol.v2.CheckRequest, com.google.api.servicecontrol.v2.CheckResponse>newBuilder()
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.api.servicecontrol.v2.ReportRequest,
      com.google.api.servicecontrol.v2.ReportResponse> getReportMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.api.servicecontrol.v2.ReportRequest,
      com.google.api.servicecontrol.v2.ReportResponse> getReportMethod() {
    io.grpc.MethodDescriptor<com.google.api.servicecontrol.v2.ReportRequest, com.google.api.servicecontrol.v2.ReportResponse> getReportMethod;
    if ((getReportMethod = ServiceControllerGrpc.getReportMethod) == null) {
      synchronized (ServiceControllerGrpc.class) {
        if ((getReportMethod = ServiceControllerGrpc.getReportMethod) == null) {
          ServiceControllerGrpc.getReportMethod = getReportMethod =
              io.grpc.MethodDescriptor.<com.google.api.servicecontrol.v2.ReportRequest, com.google.api.servicecontrol.v2.ReportResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public static ServiceControllerStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ServiceControllerStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<ServiceControllerStub>() {
        @java.lang.Override
        public ServiceControllerStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static ServiceControllerBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<ServiceControllerBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<ServiceControllerBlockingStub>() {
        @java.lang.Override
        public ServiceControllerBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static ServiceControllerFutureStub newFutureStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<ServiceControllerFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<ServiceControllerFutureStub>() {
        @java.lang.Override
        public ServiceControllerFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static abstract class ServiceControllerImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void check(com.google.api.servicecontrol.v2.CheckRequest request,
        io.grpc.stub.StreamObserver<com.google.api.servicecontrol.v2.CheckResponse> responseObserver) {
     ...
     * </pre>
     */
    public void report(com.google.api.servicecontrol.v2.ReportRequest request,
        io.grpc.stub.StreamObserver<com.google.api.servicecontrol.v2.ReportResponse> responseObserver) {
   ...
   * </pre>
   */
  public static final class ServiceControllerStub extends io.grpc.stub.AbstractAsyncStub<ServiceControllerStub> {
    private ServiceControllerStub(
   ...
   * </pre>
   */
  public static final class ServiceControllerBlockingStub extends io.grpc.stub.AbstractBlockingStub<ServiceControllerBlockingStub> {
     ...
     * </pre>
     */
    public com.google.api.servicecontrol.v2.CheckResponse check(com.google.api.servicecontrol.v2.CheckRequest request) {
     ...
     * </pre>
     */
    public com.google.api.servicecontrol.v2.ReportResponse report(com.google.api.servicecontrol.v2.ReportRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
   ...
   * </pre>
   */
  public static final class ServiceControllerFutureStub extends io.grpc.stub.AbstractFutureStub<ServiceControllerFutureStub> {
    private ServiceControllerFutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.api.servicecontrol.v2.CheckResponse> check(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.api.servicecontrol.v2.ReportResponse> report(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK:
          serviceImpl.check((com.google.api.servicecontrol.v2.CheckRequest) request,
              (io.grpc.stub.StreamObserver<com.google.api.servicecontrol.v2.CheckResponse>) responseObserver);
          break;
        case METHODID_REPORT:
          serviceImpl.report((com.google.api.servicecontrol.v2.ReportRequest) request,
              (io.grpc.stub.StreamObserver<com.google.api.servicecontrol.v2.ReportResponse>) responseObserver);
          break;
        default:
