...
public final class ShellServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<com.viam.common.v1.Common.GetStatusRequest,
    ...
    if ((getGetStatusMethod = ShellServiceGrpc.getGetStatusMethod) == null) {
      synchronized (ShellServiceGrpc.class) {
        if ((getGetStatusMethod = ShellServiceGrpc.getGetStatusMethod) == null) {
          ShellServiceGrpc.getGetStatusMethod = getGetStatusMethod =
  ...
  private static final int METHODID_SHELL = 2;
  private static final int METHODID_COPY_FILES_TO_MACHINE = 3;
  private static final int METHODID_COPY_FILES_FROM_MACHINE = 4;
