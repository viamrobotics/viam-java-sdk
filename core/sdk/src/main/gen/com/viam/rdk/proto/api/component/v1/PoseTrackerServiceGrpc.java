...
@javax.annotation.Generated(
    ...
    comments = "Source: proto/api/component/posetracker/v1/pose_tracker.proto")
public final class PoseTrackerServiceGrpc {

  private PoseTrackerServiceGrpc() {}

  public static final String SERVICE_NAME = "proto.api.component.posetracker.v1.PoseTrackerService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesRequest,
      com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesResponse> getGetPosesMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetPoses",
      requestType = com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesRequest.class,
      responseType = com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesRequest,
      com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesResponse> getGetPosesMethod() {
    io.grpc.MethodDescriptor<com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesRequest, com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesResponse> getGetPosesMethod;
      ...
      synchronized (PoseTrackerServiceGrpc.class) {
        if ((getGetPosesMethod = PoseTrackerServiceGrpc.getGetPosesMethod) == null) {
          PoseTrackerServiceGrpc.getGetPosesMethod = getGetPosesMethod =
              io.grpc.MethodDescriptor.<com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesRequest, com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetPoses"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesResponse.getDefaultInstance()))
  ...
  public static abstract class PoseTrackerServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getPoses(com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesRequest request,
        io.grpc.stub.StreamObserver<com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesRequest,
                com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesResponse>(
  ...
  public static final class PoseTrackerServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<PoseTrackerServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesResponse getPoses(com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesRequest request) {
  ...
  public static final class PoseTrackerServiceFutureStub extends io.grpc.stub.AbstractFutureStub<PoseTrackerServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesResponse> getPoses(
        com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_POSES:
          serviceImpl.getPoses((com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesRequest) request,
              (io.grpc.stub.StreamObserver<com.viam.rdk.proto.api.component.v1.PoseTracker.GetPosesResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class PoseTrackerServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.viam.rdk.proto.api.component.v1.PoseTracker.getDescriptor();
    }
