...
public class PeerConnectionFactory extends
  ...
  private static org.webrtc.PeerConnection.RTCConfiguration toNativeRTCConfiguration(
      final PeerConnection.RTCConfiguration rtcConfiguration) {
    final org.webrtc.PeerConnection.RTCConfiguration nativeConfig = new org.webrtc.PeerConnection.RTCConfiguration(
        new ArrayList<>());
  ...
  private static org.webrtc.PeerConnection.Observer toNativePeerConnectionObserver(
    ...
    return new org.webrtc.PeerConnection.Observer() {
      ...
      public void onIceConnectionChange(
          final org.webrtc.PeerConnection.IceConnectionState iceConnectionState) {
      ...
      public void onIceGatheringChange(
          final org.webrtc.PeerConnection.IceGatheringState iceGatheringState) {
