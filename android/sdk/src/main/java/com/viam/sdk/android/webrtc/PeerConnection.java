...
public class PeerConnection implements com.viam.sdk.core.webrtc.PeerConnection {
  ...
  private static org.webrtc.SessionDescription toNativeSessionDescription(
    ...
    return new org.webrtc.SessionDescription(sdpType, sessionDescription.getDescription());
  }
  ...
  public void setLocalDescription(final SessionDescription.Observer observer,
    ...
    this.nativePeerConnection.setLocalDescription(toNativeSDPObserver(observer),
        toNativeSessionDescription(sdp));
  }

  @Override
  public void setRemoteDescription(final SessionDescription.Observer observer,
      final SessionDescription sdp) {
    this.nativePeerConnection.setRemoteDescription(toNativeSDPObserver(observer),
        toNativeSessionDescription(sdp));
  }
  ...
  public void addIceCandidate(final ICECandidate candidate) {
    this.nativePeerConnection.addIceCandidate(
        new IceCandidate(candidate.sdpMid, candidate.sdpMLineIndex, candidate.sdp));
  }
