...
// TODO(erd): what can be refactored to pure java
public class Module extends BaseModule {

    // TODO(erd): to RobotClient
    RobotClient parent;
    ...
    protected void setParentAddress(final String parentAddress) {
        final ManagedChannel chan = UdsChannelBuilder.forPath(parentAddress, LocalSocketAddress.Namespace.FILESYSTEM).build();
