...
public class PeerConnection implements com.viam.sdk.core.webrtc.PeerConnection {
    ...
    public void createOffer(final SessionDescription.Observer observer) {
        this.nativePeerConnection.createOffer(new RTCOfferOptions(), toNativeCreateSDPObserver(observer));
    }

    @Override
    public void createAnswer(final SessionDescription.Observer observer) {
        this.nativePeerConnection.createAnswer(new RTCAnswerOptions(), toNativeCreateSDPObserver(observer));
    }

    @Override
    public void setLocalDescription(final SessionDescription.Observer observer, SessionDescription sdp) {
        this.nativePeerConnection.setLocalDescription(toNativeSessionDescription(sdp), toNativeSetSDPObserver(observer));
    }

    @Override
    public void setRemoteDescription(final SessionDescription.Observer observer, final SessionDescription sdp) {
        this.nativePeerConnection.setRemoteDescription(toNativeSessionDescription(sdp), toNativeSetSDPObserver(observer));
    }

    @Override
    public void addIceCandidate(final ICECandidate candidate) {
        this.nativePeerConnection.addIceCandidate(new RTCIceCandidate(candidate.sdpMid, candidate.sdpMLineIndex, candidate.sdp));
    }
    ...
    private SetSessionDescriptionObserver toNativeSetSDPObserver(final SessionDescription.Observer observer) {
    ...
    private CreateSessionDescriptionObserver toNativeCreateSDPObserver(final SessionDescription.Observer observer) {
    ...
    private static SessionDescription toSessionDescription(final RTCSessionDescription sessionDescription) {
    ...
    private static RTCSessionDescription toNativeSessionDescription(final SessionDescription sessionDescription) {
